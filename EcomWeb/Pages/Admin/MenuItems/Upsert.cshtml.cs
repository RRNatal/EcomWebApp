...
namespace EcomWeb.Pages.Admin.MenuItems;
...
public class UpsertModel : PageModel
{
    ...
    public IEnumerable<SelectListItem> MainCatList { get; set; }
    ...
    public void OnGet(int? id)
    {
        ...
        MainCatList = _unitOfWork.MainCat.GetAll().Select(i => new SelectListItem()
        {
            Text = i.Name,
            Value = i.Id.ToString()
        });
